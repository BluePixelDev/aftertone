...
namespace BP.OneShotSFXEditor
{
    [CustomEditor(typeof(OneShotAsset))]
    public class OneShotAssetEditor : Editor
    {
        [SerializeField] private VisualTreeAsset dropzoneAsset;
        [SerializeField] private VisualTreeAsset treeAsset;

        private OneShotAsset asset;
        private AudioSource previewSource;

        private void OnEnable()
        {
            asset = (OneShotAsset)target;
